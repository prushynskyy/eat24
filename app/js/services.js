...
angular.module('myApp.services', [])
	.value('FIREBASE_URL', 'https://eat24.firebaseio.com/')
	...
	.factory('authService', function($firebaseSimpleLogin, $location, $rootScope, FIREBASE_URL, dataService) {
		...
		// want something occur in the user object and refernce some of it into our scope
		$rootScope.$on("$firebaseSimpleLogin:login", function(e, user) {
		  //Save current user on root scope
